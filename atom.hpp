...
public:
  ...
  /// Construct an Atom of type complx Number with value
  ...
  /// predicate to determine if an Atom is of type Complex Number
  bool isComplexNumber() const  noexcept;

  /// predicate to determine if an Atom is of type Symbol
  bool isSymbol() const noexcept;

  /// predicate to determine if an Atom is of type String Literal 
  bool isStringLiteral() const noexcept;

  /// value of Atom as a number, return 0 if not a Number
  double asNumber() const noexcept;

  /// value of Atom as a complex number, return 0 if not a complex Number
  std::complex<double> asComplexNumber() const noexcept;

  /// value of Atom as a number, returns empty-string if not a Symbol
  std::string asSymbol() const noexcept;

  /// value of Atom as a number, returns empty-string if not a String Literal
  std::string asStringLiteral() const noexcept;
