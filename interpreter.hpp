...
//typedef MessageQueue<std::string> inputMessage;
//typedef MessageQueue<messageOut> outputMessage;
//typedef MessageQueue<Message> inputQueue;
//typedef MessageQueue<Expression> outputQueue;

//static outputQueue outputMessage;
//static inputQueue inputMessage;
/*! \class Interpreter
